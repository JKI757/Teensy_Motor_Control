...
int in2pin=3;
int dcmotorpwmpin=5;
L298N driveMotor(in1pin, in2pin, dcmotorpwmpin);
...
int max_steering_input=255;//this is the max number event loop will send me
...
int map_steering_angle(int val){
  ...
  angle = map(val, -max_steering_input, max_steering_input, max_left_steering_angle, max_right_steering_angle);
